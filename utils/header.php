    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>SCHEDULING YOUR EVENTS!!</h1><!--jumbotron heading-->
                <p class="schedule"><!--jumbotron content-->
                Whether you're looking to book a cocktail party, post-work gathering, celebratory function, conference, business
                meeting, wedding or private dining event, our dedicated "SCHEDULING YOUR EVENTS" team can create a package that will meet
                your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
